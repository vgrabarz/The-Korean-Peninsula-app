...
all_rc = terra::rast("~/pracainz/landocover/alllandcover.tif")
...
granice = read_sf("~/pracainz/granice/granice.shp")
...
server <- function(input, output) {
  ...
  rr2 = reactive({
    my_compare = terra::rast(paste0("~/strona/Korea/compare/", input$year1, "_", input$year2, ".tif"))
  })
  ...
  rr3 = reactive({
    my_compare3 = sf::read_sf(paste0("~/strona/Korea/compare_polygon/", input$year1comp, "_", input$year2comp, ".gpkg"))
  })
  ...
  rr4 = reactive({
    my_compare4 = sf::read_sf(paste0("~/strona/Korea/cluster/", input$year1cluster, "_", input$k_cluster, ".gpkg"))
  })
  ...
  rr5 = reactive({
    my_compare5 = sf::read_sf(paste0("~/strona/Korea/cluster_poly/", input$year1_clusterarea, "_", input$k_clusterarea, ".gpkg"))
  })
